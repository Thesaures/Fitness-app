import { EMAIL_REGEX,CAPITAL_REGEX,SYMBOL_REGEX,NUMBER_REGEX,USERNAME_REGEX,CHECK_USERNAME } from "./constants/Constants";
interface inputs {
    name:string;
    number:string;
    email:string;
...
export function updatingTask (dataArray:daraarray[],setNewDataArray,newDataArray){
